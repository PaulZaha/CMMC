...
pos_encoding = np.load("openvinomodels_raw/positional_encoding.npy")
pe = core.compile_model(model="openvinomodels_raw/prompt_encoder.xml", device_name="CPU")
sessions = dict()

def load_session(name):
    if name not in sessions:
        ie = core.compile_model(model="openvinomodels_raw/"+name+"_image_encoder.xml", device_name="CPU")
        md = core.compile_model(model="openvinomodels_raw/"+name+"_mask_decoder.xml", device_name="CPU")
