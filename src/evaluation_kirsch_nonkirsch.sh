...
#modalities=("Fundus" "Mammography" "Microscopy" "OCT" "US" "XRay")
modalities=("XRay")

# Schleife über jede Modalität und führe den Befehl aus
for modality in "${modalities[@]}"; do
    python evaluation/compute_metrics.py \
        -s test_demo/v2_bigval/edge_val/${modality} \
        -g test_demo/v2_bigval/edge_val/${modality} \
        -csv_dir ./results/v3/metrics_edge_${modality}.csv
